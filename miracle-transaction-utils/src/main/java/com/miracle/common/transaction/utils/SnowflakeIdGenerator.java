...
public class SnowflakeIdGenerator {
	...
	// ==============================Fields===========================================
	/** 开始时间截 (2017-07-07) */
	private final long twepoch = 1499356800000l;
	...
	@Autowired
	private DistributedWorkerId workIdGenerator;
	
	@PostConstruct
	private void init() {
		int workerId = workIdGenerator.getCurWorkerId();
		if (workerId < 0) {
			throw new IllegalStateException("No right workerId be prepared.");
		}
	}
